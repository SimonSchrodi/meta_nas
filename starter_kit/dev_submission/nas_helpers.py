...
def sample_config_return_model(cs, input_shape):
...
if __name__ == "__main__":
    ...
    '''
    Iterate over devel datasets, sample and validate n configs
    '''
    ...
    for dataset_path in get_dataset_paths(input_dir):
        ...
        for _ in range(10):
            model, config = sample_config_return_model(cs, input_shape)
