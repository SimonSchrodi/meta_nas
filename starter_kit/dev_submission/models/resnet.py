...
@register_model
def wide_resnet18_2(pretrained=False, **kwargs):
    """Constructs a Wide ResNet-18-2 model.
    The model is the same as ResNet except for the bottleneck number of channels
    which is twice larger in every block. The number of channels in outer 1x1
    convolutions is the same, e.g. last block in ResNet-50 has 2048-512-2048
    channels, and in Wide ResNet-50-2 has 2048-1024-2048.
    """
    model_args = dict(block=Bottleneck, layers=[2, 2, 2, 2], base_width=128, **kwargs)
    return _create_resnet('wide_resnet18_2', pretrained, **model_args)
...
@register_model
def resnext18_32x4d(pretrained=False, **kwargs):
    """Constructs a ResNeXt18-32x4d model.
    """
    model_args = dict(block=Bottleneck, layers=[2, 2, 2, 2], cardinality=32, base_width=4, **kwargs)
    return _create_resnet('resnext18_32x4d', pretrained, **model_args)
