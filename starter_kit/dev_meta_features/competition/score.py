...
try:
    from competition.libscores import _HERE
    from competition.libscores import get_logger
    from competition.libscores import ls
    from competition.libscores import mvmean
    from competition.libscores import read_array
    from competition.libscores import sp
    from competition.libscores import tiedrank
except ImportError:
