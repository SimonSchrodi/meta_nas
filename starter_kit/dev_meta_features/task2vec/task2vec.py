...
class Task2Vec:
    ...
    def embed(self, dataset: Dataset):
        ...
        metrics = self._fit_classifier(**self.classifier_opts)
    ...
    def _run_epoch(self, data_loader: DataLoader, model: ProbeNetwork, loss_fn, optimizer: Optimizer, epoch: int, train: bool = True, add_compression_loss: bool = False, skip_layers=0, beta=1.0e-7):
