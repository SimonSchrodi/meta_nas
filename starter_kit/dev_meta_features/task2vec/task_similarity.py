...
def plot_distance_matrix(embeddings, labels=None, distance='cosine', savepath = None):
    ...
    sns.clustermap(distance_matrix, row_linkage=linkage_matrix, col_linkage=linkage_matrix, cmap='viridis_r', figsize = (figsize, figsize))
